...
public class XieleishangpinEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XieleishangpinEntity() {
		
	}
	
	public XieleishangpinEntity(T t) {
		try {
	 ...
	 * 设置：鞋子编号
	 */
	public void setXiezibianhao(String xiezibianhao) {
		this.xiezibianhao = xiezibianhao;
	}
	/**
	 * 获取：鞋子编号
	 */
	public String getXiezibianhao() {
		return xiezibianhao;
	}
	/**
	 * 设置：鞋子名称
