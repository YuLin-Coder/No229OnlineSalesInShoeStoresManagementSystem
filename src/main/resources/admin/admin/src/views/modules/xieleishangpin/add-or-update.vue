<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="鞋子编号" prop="xiezibianhao">
            <el-input v-model="ruleForm.xiezibianhao" 
                placeholder="鞋子编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiezibianhao" label="鞋子编号" prop="xiezibianhao">
              <el-input v-model="ruleForm.xiezibianhao" 
                placeholder="鞋子编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="鞋子名称" prop="xiezimingcheng">
          <el-input v-model="ruleForm.xiezimingcheng" 
              placeholder="鞋子名称" clearable  :readonly="ro.xiezimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="鞋子名称" prop="xiezimingcheng">
              <el-input v-model="ruleForm.xiezimingcheng" 
                placeholder="鞋子名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="鞋子分类" prop="xiezifenlei">
          <el-select v-model="ruleForm.xiezifenlei" placeholder="请选择鞋子分类">
            <el-option
                v-for="(item,index) in xiezifenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="鞋子分类" prop="xiezifenlei">
	      <el-input v-model="ruleForm.xiezifenlei"
                placeholder="鞋子分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="鞋子介绍" prop="xiezijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiezijieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiezijieshao" label="鞋子介绍" prop="xiezijieshao">
                    <span v-html="ruleForm.xiezijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xiezibianhao'){
            this.ruleForm.xiezibianhao = obj[o];
	    this.ro.xiezibianhao = true;
            continue;
          }
          if(o=='xiezimingcheng'){
            this.ruleForm.xiezimingcheng = obj[o];
	    this.ro.xiezimingcheng = true;
            continue;
          }
          if(o=='xiezifenlei'){
            this.ruleForm.xiezifenlei = obj[o];
	    this.ro.xiezifenlei = true;
            continue;
          }
          if(o=='pinpai'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='xiezijieshao'){
            this.ruleForm.xiezijieshao = obj[o];
	    this.ro.xiezijieshao = true;
            continue;
          }
          if(o=='clicktime'){
	...
	this.ruleForm.xiezijieshao = this.ruleForm.xiezijieshao.replace(reg,'../../../springbootc171e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xieleishangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xieleishangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
